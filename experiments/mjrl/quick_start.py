...
variant_trpo_natural_adam = [21,                       # seed
                            'HalfCheetahMuJoCoEnv-v0',     # environment
                            'npg',                   # algorithm (in this case, computes step size)
